...
// * * * * * * * * * * * * * * * * * * * * * * *
/// SOURCE https://cv.toranzo.dev/awesome-dialog
// * * * * * * * * * * * * * * * * * * * * * * *

class AwesomeDialogBox extends StatelessWidget {
  const AwesomeDialogBox({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Awesome Dialog Boxes')),
      body: Center(
        child: SingleChildScrollView(
          child: Column(
            children: [
              AnimatedButton(
                text: 'Info Dialog -- width and square buttons',
                pressEvent: () {
                  AwesomeDialog(
                    transitionAnimationDuration: Duration(milliseconds: 3500),
                    context: context,
                    ...
                    showCloseIcon: true,
                    closeIcon: Icon(Icons.diamond_sharp),
                    btnCancelOnPress: () {},
                    btnOkOnPress: () {},
                  ).show();
                },
