      ...
      body: Container(
        ...
        child: ListView(
          padding: EdgeInsets.all(
              20), //adds additional layer of padding around the entire listview
          scrollDirection: Axis.vertical,
          reverse: false, // if true, makes the listview start from the bottom
          shrinkWrap:
              true, // if false: takes the H/W of the wrapped container, if true: minimizes the H/W as much as posible

          // physics:  ClampingScrollPhysics(), //default, only a slight effect when 'scrolling for a refresh'
          physics:
              BouncingScrollPhysics(), // bounces when 'scrolling for a refresh'
          ...
          keyboardDismissBehavior:
              ScrollViewKeyboardDismissBehavior.onDrag, //manual by defaul
